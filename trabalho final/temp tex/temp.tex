...
As Figuras~\ref{fig:q_ref_vs_recuperacao_h2s} a \ref{fig:q_ref_vs_t_topo} apresentam o comportamento geral da torre esgotadora de H\textsubscript{2}S em função da carga térmica do refervedor. Observa-se claramente a existência de um \textit{trade-off} operacional fundamental: o aumento da carga térmica promove maior vaporização de H\textsubscript{2}S (aumentando a recuperação), porém simultaneamente eleva a temperatura na torre, favorecendo também a vaporização de NH\textsubscript{3}.

Na Figura~\ref{fig:q_ref_vs_recuperacao_h2s}, nota-se que a recuperação de H\textsubscript{2}S aumenta rapidamente com o incremento da carga térmica, atingindo patamares próximos a 100\% para valores de carga térmica acima de 3,0 Gcal/h. Este comportamento é esperado devido à maior volatilidade relativa do H\textsubscript{2}S em comparação à NH\textsubscript{3} nas condições operacionais da torre.

A Figura~\ref{fig:q_ref_vs_perda_nh3} revela o fenômeno crítico de arraste de amônia: após a recuperação completa de H\textsubscript{2}S, qualquer aumento adicional na carga térmica resulta em elevação acentuada da perda de NH\textsubscript{3} para o gás ácido. Esse comportamento é indesejável pois a presença de NH\textsubscript{3} no gás ácido enviado à URE pode causar formação de sais de amônio (NH\textsubscript{4}HS), levando a problemas operacionais como incrustações, entupimentos e corrosão.
