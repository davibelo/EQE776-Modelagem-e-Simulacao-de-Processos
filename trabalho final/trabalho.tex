...
\begin{itemize}[leftmargin=*]
  \item As condições operacionais da torre (60–180 °C; 6 bar) estão dentro dos limites de validação do modelo.
...
Conforme discutido na \cref{sec:bibliografia}, o modelo GPSWAT é particularmente adequado para aplicações em torres esgotadoras de águas ácidas, pois:
