...
Portanto, a seleção do GPSWAT para as simulações deste trabalho está justificada tecnicamente e operacionalmente. Recomenda-se complementar as simulações com testes de sensibilidade e, quando possível, comparação com dados experimentais.
...
\bibitem{gpa1990} Gas Processors Association (GPA). (1990). \emph{Sour Water Systems Data Book}. Tulsa, OK: Gas Processors Association.

\bibitem{kohl1997} Kohl, A. L.; Nielsen, R. B. (1997). \emph{Gas Purification}, 5th ed. Houston: Gulf Publishing Company. ISBN 0-88415-220-0.
