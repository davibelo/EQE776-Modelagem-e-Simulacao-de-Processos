...
\begin{itemize}[leftmargin=*]
  ...
  \item Operation specifications: Reboiler Duty
...
Essa alimentação de água tratada no estágio 7 serve como acréscimo de um refluxo líquido somado com o refluxo gerado pelo "pumparound" além de uma seção de lavagem interna para remoção adicional de NH\textsubscript{3}.
